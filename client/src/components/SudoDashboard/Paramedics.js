    ...
    return(
        <div className="admin_ambulances">
            ...
            <h2>Update Paramedic</h2>
                ...
                <p>Enter phone no:</p>
                <input type="number" placeholder="Enter paramedic phone number" />
                <p>Ambulance ID:</p>
                <input type="number" placeholder="Enter ambulance id" />
                <p>Medical License no:</p>
                <input type="text" placeholder="Enter medical license no" />
            ...
            <div className="custom_model_delete" id="custom_model_delete">
                ...
                <h2>Are you sure you want to delete paramedic with ID 10092?</h2>
            ...
            <h1>Paramedics</h1>
            <p style={{marginLeft: "20px",color: "#ff5049"}} ><b>Available Paramedics (198)</b> <motion.button className="add_ambulance_button" onClick={addParamedic}  whileTap={{scale: 0.9}}  >Add <i className="fa-solid fa-plus"></i></motion.button></p>
